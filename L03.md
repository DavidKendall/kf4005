...
2. Use the `if...fi` statement to check if the directories exist (`[ -d $1 ]`
   _etc_), if not create them.  [[sample solution](https://gist.github.com/dr-alun-moon/bf6ff0f0c400333981e359ca30fe2693)]
3. Use a `for f in *.c` loop to test whether each file exists. If it does
   exist it can be moved.
	[[sample
solution](https://gist.github.com/dr-alun-moon/a48583441fc7fc48dbff08463012d17c)]
...
3. Add one of these variants to the reporting program above.
 [[sample solution](https://gist.github.com/dr-alun-moon/59015cffb15f233fee01fbf1ef8c56cc)]
...
solution](https://gist.github.com/dr-alun-moon/683677abc4c6f9d44ffb2d5732727754)] 
